...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _user_dashboard_user_dashboard_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./user-dashboard/user-dashboard.component */
    "./src/app/user-dashboard/user-dashboard.component.ts");
    /* harmony import */


    var _user_user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
  ...
  function srcAppHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HeaderComponent = /*#__PURE__*/function () {
      function HeaderComponent(authUserService, router, route) {
      ...
      _createClass(ReportsComponent, [{
        ...
        value: function getAllUserReports() {
          ...
          this.beauticianService.getAllUserReportsById(userReportsPayload).subscribe(function (response) {
            ...
            if (response.success) {
              _this19.reports = response.data;
              _this19.count = response.count;

              _this19.createPager();
            } else {
              _this19.toastr.errorToastr(response.message);
            }
          }, function (error) {
            _this19.toastr.errorToastr("Network failed, Please try again.");
          });
        }
      }, {
        key: "getPage",
